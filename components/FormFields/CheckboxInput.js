        ...
        <div className="group">
            <label className="flex items-center space-x-3 cursor-pointer">
                <div className="relative">
                    ...
                    <div
                        className={`w-5 h-5 rounded border border-gray-300 bg-white transition-all duration-200 flex items-center justify-center ${error ? "border-red-500" : ""
                    ...
                    >
                        <Icon
                            icon="mdi:check"
                            className={`h-4 w-4 text-primary transition-opacity duration-200 ${props.checked || props.defaultChecked
                                ? "opacity-100"
                                : "opacity-0"
                                }`}
                        />
