...
const Signin = ({ isModalOpen, setIsModalOpen, setFormType }) => {
  ...
  return (
    <Form {...methods}>
      ...
      <form
        ...
        className={"w-full mt-8 lg:px-6 px-4"}
      >
        <Heading2 blackHeading={currentTranslations?.loginTitle} className={`text-center`} />
        <br />
        <div className="space-y-6 mb-6">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <span
              onClick={() => setFormType("recoverpassword")}
