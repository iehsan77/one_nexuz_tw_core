...
const Link = ({
  ...
  return (
    <NextLink
      href={href}
      className={`displayPara rounded-xs text-nowrap sm:text-base text-xs sm:px-6 px-4 py-2 text-center transition-all duration-500 flex items-center justify-center ${className}
        ${variant === "primary"
