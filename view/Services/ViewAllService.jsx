...
//   // Unique key generator for each level
//   const generateKey = (level1, level2, level3, level4) => {
...
//   const toggleDropdown = (key) => {
//     setOpenDropdowns((prev) => ({
//       // Sirf clicked wala toggle hoga, baaki same rahenge
//       [key]: !prev[key],
//     }));
//   };
...
//                                     className={`transition-all duration-300 ease-in-out overflow-hidden ${
//                                       isDropdownOpen(
//                                         generateKey(service.id, tab.id, item.id)
//                                       )
//                                         ? "max-h-96 opacity-100 mt-2"
//                                         : "max-h-0 opacity-0"
//                                     }`}>
...
//                       key={generateKey(service.id, item.id)}
//                       className={`${
//                         item?.title === "" ? "md:col-span-2 lg:col-span-3" : ""
//                       }`}>
//                       {/* Item Title - Original Styling */}
//                       {item?.title !== "" && (
//                         <LanguageAwareLink href={item?.url || "#"}>
...
//                         {item?.links?.map((linkItem) => (
//                           <div
//                             key={generateKey(service.id, item.id, linkItem.id)}>
//                             {/* Link Item with Title */}
//                             {linkItem.title && (
//                               <div>
//                                 <div className="flex items-center justify-between gap-3">
