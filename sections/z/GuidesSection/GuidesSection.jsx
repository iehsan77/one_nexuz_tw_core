...
import GuidesCards from "@/components/Card/GuidesCards";
...
const GuidesSection = ({ heading, data, paragraph }) => {
    const { locale } = useContext(LanguageContext);
    const btnText = locale === "ar" ? btnTextAr : btnTextEn;
  return (
    <section className="secPadding bg-[url(/assets/icons/wm_09.svg)] bg-no-repeat bg-top-right">
      <div className="container">
        ...
        <div className="dot">
          <Splide
          options={options}
          aria-labelledby="luxora-community-slider"
          hasTrack={false}
        >
